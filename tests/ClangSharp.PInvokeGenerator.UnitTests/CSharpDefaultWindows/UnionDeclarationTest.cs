...
{{
    ...
    {{
        ...
        public ref _Anonymous_e__Struct._Anonymous1_e__Union._A_e__Struct A
        {{
            get
            {{
                return ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous1.A, 1));
            }}
        }}

        public ref _Anonymous_e__Struct._Anonymous1_e__Union._B_e__Struct B
        {{
            get
            {{
                return ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous1.B, 1));
            }}
        }}
