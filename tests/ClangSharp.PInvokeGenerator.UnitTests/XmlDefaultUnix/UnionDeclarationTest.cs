...
<bindings>
  <namespace name=""ClangSharp.Test"">
    <struct name=""_MY_UNION"" access=""public"" layout=""Explicit"">
      ...
      <field name=""A"" access=""public"">
        <type>ref _Anonymous_e__Struct._Anonymous1_e__Union._A_e__Struct</type>
        <get>
          <code>return ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous1.A, 1));</code>
        </get>
      </field>
      <field name=""B"" access=""public"">
        <type>ref _Anonymous_e__Struct._Anonymous1_e__Union._B_e__Struct</type>
        <get>
          <code>return ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.Anonymous1.B, 1));</code>
        </get>
      </field>
      <struct name=""_Anonymous_e__Struct"" access=""public"">
        ...
        <field name=""Anonymous1"" access=""public"">
          <type native=""__AnonymousRecord_ClangUnsavedFile_L7_C9"">_Anonymous1_e__Union</type>
        </field>
        <struct name=""_Anonymous1_e__Union"" access=""public"" layout=""Explicit"">
          <field name=""A"" access=""public"" offset=""0"">
